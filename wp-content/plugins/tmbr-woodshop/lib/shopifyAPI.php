<?php
/*
Plugin Name: Shopify API
Plugin URI:
Creates a simple extension for Shopify API in PHP
Version: 1.0
Author: TMBR
...
class ShopifyAPI
{
    public $api_key = "bab956479eb2658a36ea81704d5afe8c";
    public $password = "642f314689563a35036ce171b0fa57ee";
    public $secret = "8fc6505b6573f079f21d34c1ba02a3fe";
    public $debug = false;
    ...
    public $base_url = "guenergy-2.myshopify.com/admin";
    ...
    {
        //parent::__construct();  //Can be extended
        $this->api_url = 'https://'.$this->api_key.':'.$this->password.'@'.$this->base_url; //Set API Info
        //echo $this->api_url;
    }

    // Function is called to submit all requests
...
//        $this->debug = true;
    ...
    public function updateCustomerTag($customerID, $tags)
    {
      $this->api_extension = 'customers/'.$customerID.'.json';
      $this->method = 'PUT';
