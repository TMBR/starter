<?php
/**
 * Manage upgrades for the Tribe Events Filter plugin
 *
...
if( !class_exists( 'TribeEventsFilterPUE' ) ) {
	class TribeEventsFilterPUE {

		/**
		 * @var string slug used for the plugin update engine
		 */
		private static $pue_slug = 'tribe-filterbar';
