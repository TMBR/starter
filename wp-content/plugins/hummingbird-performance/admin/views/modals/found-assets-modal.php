...
?>
<div class="dialog sui-dialog sui-dialog-sm wphb-assets-modal" aria-hidden="true" id="wphb-assets-modal">
	...
	<div class="sui-dialog-content" aria-labelledby="assetsFound" aria-describedby="dialogDescription" role="dialog">
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-body">
				<p>
					<?php esc_html_e( 'Next, optimize your file structure by turning on compression, and moving
				files in order to speed up your page load times.', 'wphb' ); ?>
				</p>

				<div class="sui-notice sui-notice-warning">
					<p>
						<?php esc_html_e( 'This is an advanced feature and can break themes easily. We
