...
if($layout == 'default') {
  ...
  tmbr_load_template( 'new-partials/layout/default.php', array(
...
elseif($layout == 'text_img') {
  ...
  if($img_align == 'left_img') {
    tmbr_load_template( 'new-partials/layout/left-img.php', array(
      'img' => (isset($img_split)) ? $img_split : null,
      'content' => (isset($right_text)) ? $right_text : null
    ));
  }
  elseif($img_align == 'right_img') {
    tmbr_load_template( 'new-partials/layout/right-img.php', array(
      'img' => (isset($img_split)) ? $img_split : null,
...
elseif($layout == '2_col') {
  ...
  tmbr_load_template( 'new-partials/layout/2-col.php', array(
...
elseif($layout == '3_col') {
  ...
  tmbr_load_template( 'new-partials/layout/3-col.php', array(
